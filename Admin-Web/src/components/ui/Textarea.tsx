    ...
    return (
      <div className="w-full">
        <textarea
          ...
          disabled={disabled}
          className={clsx(
            'w-full transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed border resize-vertical',
            sizeClasses[size],
            disabled
